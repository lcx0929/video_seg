...
def parse_args(args):
    ...
    parser.add_argument(
        "--version", default="./pre_model/llava_7b"
    )
    ...
    parser.add_argument(
        "--vision-tower", default="./pre_model/clip-vit-large-patch14", type=str
    )
    ...
    parser.add_argument("--vision_pretrained", default="./pre_model/sam/sam_vit_h.pth", type=str)
